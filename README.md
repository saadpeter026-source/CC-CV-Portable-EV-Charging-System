...
Although the CV region only lasts approximately 2.17 seconds, the SOC increase is only 0.00628%, compared to 0.0272% during the 8.6541-second CC region. This is expected because the charging current begins to decrease during CV mode, reducing the rate at which the battery gains charge.
